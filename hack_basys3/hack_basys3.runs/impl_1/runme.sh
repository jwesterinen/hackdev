...
HD_PWD='/home/jeff/devel/hackdev/hack_basys3/hack_basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hack.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hack.tcl -notrace
