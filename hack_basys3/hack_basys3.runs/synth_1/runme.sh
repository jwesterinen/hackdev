...
HD_PWD='/home/jeff/devel/hackdev/hack_basys3/hack_basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hack.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hack.tcl
